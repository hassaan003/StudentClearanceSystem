...
// import { CLEARANCE_REQ_URL } from '../endPoints';
// import { CLEARANCE_STATUS_URL } from '../endPoints';
// import { PENDING_REQS_URL } from '../endPoints';
// import { CLEARANCE_ACTION_URL } from '../endPoints';
// import { RESUBMIT_REQS_URL } from '../endPoints';
// import { GETRE_REQS_URL } from '../endPoints';
...
//     try {
//       setLoading(true);
//       setDashboardMsg(true);

//       const response = await fetch(RESUBMIT_REQS_URL, {
//         method: 'POST',
...
//       if (response.ok) {
//         setDashboardMsg("request sumitted");
//         setClearanceData(data.clearance);
//       }
//       else {
//         setDashboardMsg("error");
//       }
//     }
//     catch (error) {
//       setDashboardMsg("connection failed");
//     }
//     finally {
//       setLoading(false);
//     }
...
//   const getResubmittedRequests = async () => {
//     try {
//       const response = await fetch(`${GETRE_REQS_URL}?departmentRole=${user.role}`);
//       const data = await response.json();
//       if (response.ok) {
//         setResubmittedStudents(data.requests);
//       }
//       else {
//         setDashboardMsg("couldn't fetch stuents");
//       }
//     }
//     catch (error) {
//       setDashboardMsg("error",)
...
//     setLoading = true;
//     await Promise.all([fetchPendingStudents(), getResubmittedRequests()]);
//     setLoading = false;
//   }
...
//     return rollNo.toLowerCase().includes(seachQuery.toLowerCase());
//   });
...
//                               <button onClick={handleResubmit(deptKey)}>Resubmit</button>
//                             </div>
//                           )}
//                         </div>
//                       );
...
//       <div style={workspaceStyle}>
//         <h2 style={{ textAlign: 'center', marginTop: '10px' }}>Resubmitted Requests</h2>
//         {filteredResubmitted.length === 0 ? (
//           <p style={{ textAlign: 'center', }}>No resubmitted request</p>
//         ) : (
//           <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
...
//                 {activeRejectionRequest === request._id ? (
//                   <div style={rejectionModalStyle}>
//                     <label>write rejection reason</label>
//                     <textarea
//                       value={rejectionReason}
//                       onChange={(e) => setRejectionReason(e.target.value)}
//                       required
